...
//All keywords
%token KW_IF KW_IS KW_VAR KW_END KW_TRUE KW_FALSE KW_THEN KW_ELSE KW_FOR KW_LOOP KW_IN KW_WHILE KW_FUNC KW_RETURN KW_PRINT
...
FunctionDef : KW_FUNC LPAREN Params RPAREN KW_IS Body KW_END ;
